...
<html lang="en">
    <head>
        ...
        <title>MyShuttle | Swift and Efficient</title>
    ...
    <body>
        ...
        <section style="padding-top: 150px;">
            <div class="container-fluid top-margin ">
                <div class="row">
                    <div class="col-lg-1 md-12"></div>
                    <div class="col-lg-5 md-12 mr-5 ml-3">
                        <h1>Swift, Prompt and Efficient Shuttling</h1>
			<p class="page-font ">MyShuttle has been launched to bring relief to the thousands of commuters within the FUTO community.<br /><br />We're here to bring you comfort. Any question: 08148021754<br /></p> 
                        <a class="btn btn-primary" href="signup.jsp">Sign Up Now</a> 
                    </div>
